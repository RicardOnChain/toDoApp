...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `h1,h2,h3,h4,body, button, span{
    margin:0;
    padding: 0;
}
...
.whiteText, .taskName, span{
    font-size: 1em;
    color:  rgb(218, 233, 233);
}
    
.greyText, .taskPriority, .taskDate{
    font-size: 0.9em;
    color:  rgb(91, 91, 91);
    min-width: 100px;
}
...
dialog{
    ...
    border-radius: 13px;
    box-shadow: 4px 4px 5px rgb(0, 0, 0, 90%);
...
#listModal>#createList{
    color: white;
    padding: 5px 15px;
    background-color: rgb(36, 106, 211);
    border-radius: 15px;
    grid-column: 2/3;
    grid-row:3/4
...
.taskCard{
    display: grid;
    grid-template-columns: 50px 2fr 5fr;
...
/* New/update Task Modal*/


#newTaskModal>form, #updateTaskModal>form{
    display: grid;
...
#createTask:hover, #updateTask:hover{
    background-color: #006aff;
}


`, "",{"version":3,"sources":["webpack://./src/styles.css"],"names":[],"mappings":"AAAA;IACI,QAAQ;IACR,UAAU;AACd;;AAEA;IACI,aAAa;IACb,aAAa;IACb,8BAA8B;IAC9B,mFAAmF;;AAEvF;;AAEA,YAAY;;AAEZ;IACI,cAAc;IACd,0BAA0B;AAC9B;;AAEA;IACI,gBAAgB;IAChB,uBAAuB;IACvB,gBAAgB;AACpB;;AAEA;IACI,iBAAiB;IACjB,aAAa;IACb,sBAAsB;IACtB,WAAW;IACX,sBAAsB;AAC1B;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,gBAAgB;IAChB,mBAAmB;IACnB,iBAAiB;AACrB;;AAEA;IACI,aAAa;IACb,WAAW;AACf;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,iBAAiB;IACjB,iBAAiB;IACjB,mBAAmB;;AAEvB;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,iBAAiB;AACrB;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,mBAAmB;IACnB,gCAAgC;IAChC,QAAQ;IACR,gBAAgB;IAChB,mBAAmB;AACvB;;AAEA;IACI,yBAAyB;AAC7B;AACA;IACI,eAAe;IACf,WAAW;IACX,UAAU;IACV,SAAS;;AAEb;;AAEA;IACI,6BAA6B;IAC7B,YAAY;IACZ,eAAe;IACf,OAAO;AACX;;AAEA;IACI,aAAa;AACjB;;AAEA,mBAAmB;;AAEnB;IACI,qCAAqC;IACrC,QAAQ;IACR,yBAAyB;IACzB,mBAAmB;IACnB,yCAAyC;;AAE7C;;AAEA;IACI,2BAA2B;IAC3B,0BAA0B;AAC9B;;AAEA;IACI,aAAa;IACb,8BAA8B;IAC9B,SAAS;IACT,aAAa;IACb,YAAY;AAChB;;AAEA;IACI,YAAY;IACZ,gBAAgB;IAChB,aAAa;IACb,6BAA6B;IAC7B,YAAY;IACZ,gBAAgB;IAChB,YAAY;AAChB;;AAEA;IACI,aAAa;IACb,yBAAyB;AAC7B;;AAEA;IACI,YAAY;IACZ,iBAAiB;IACjB,mCAAmC;IACnC,mBAAmB;IACnB,gBAAgB;IAChB;;AAEJ;;AAEA;IACI,gBAAgB;IAChB,aAAa;IACb,WAAW;IACX,iBAAiB;AACrB;;;;AAIA,gBAAgB;;AAEhB;IACI,aAAa;IACb,sBAAsB;IACtB,SAAS;IACT,aAAa;IACb,aAAa;IACb,sBAAsB;IACtB,yBAAyB;AAC7B;;AAEA;IACI,kBAAkB;IAClB,qCAAqC;IACrC,mBAAmB;IACnB,aAAa;IACb,qBAAqB;AACzB;;AAEA;IACI,0BAA0B;IAC1B,2BAA2B;;AAE/B;;AAEA;IACI,OAAO;IACP,aAAa;IACb,gBAAgB;IAChB,mBAAmB;IACnB,yCAAyC;AAC7C;;;AAGA;IACI,aAAa;IACb,sBAAsB;IACtB,OAAO;IACP,qCAAqC;IACrC,QAAQ;IACR,aAAa;IACb,gBAAgB;;AAEpB;;AAEA;IACI,aAAa;IACb,qBAAqB;IACrB,YAAY;IACZ,yBAAyB;IACzB,mBAAmB;IACnB,iBAAiB;IACjB,kBAAkB;IAClB,SAAS;IACT,gCAAgC;;AAEpC;;AAEA;IACI,yBAAyB;;AAE7B;;AAEA;IACI,YAAY;IACZ,YAAY;AAChB;;AAEA;IACI,WAAW;AACf;;;;AAIA,cAAc;;AAEd;IACI,aAAa;IACb,mCAAmC;IACnC,qBAAqB;IACrB,qCAAqC;IACrC,YAAY;IACZ,OAAO;IACP,iBAAiB;IACjB,aAAa;IACb,kBAAkB;AACtB;;AAEA;IACI,kBAAkB;IAClB,WAAW;IACX,YAAY;IACZ,yBAAyB;IACzB,yBAAyB;IACzB,gCAAgC;IAChC,eAAe;IACf,gBAAgB;IAChB,aAAa;IACb,kBAAkB;IAClB,aAAa;IACb,uBAAuB;IACvB,qBAAqB;AACzB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,yBAAyB;IACzB,yBAAyB;;;AAG7B;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,6BAA6B;IAC7B,yBAAyB;AAC7B;;AAEA;IACI,gBAAgB;IAChB,aAAa;;AAEjB;;AAEA;IACI,gBAAgB;IAChB,aAAa;AACjB;;AAEA;IACI,gBAAgB;IAChB,aAAa;AACjB;;AAEA;IACI,gBAAgB;IAChB,aAAa;IACb,kBAAkB;IAClB,iBAAiB;IACjB,aAAa;IACb,QAAQ;AACZ;;AAEA;IACI,eAAe;AACnB;;AAEA,yBAAyB;;;AAGzB;IACI,aAAa;IACb,8BAA8B;IAC9B,wCAAwC;IACxC,aAAa;IACb;AACJ;;AAEA;IACI,gBAAgB;IAChB,aAAa;IACb,iBAAiB;AACrB;;AAEA;IACI,gBAAgB;IAChB,aAAa;AACjB;;AAEA;IACI,gBAAgB;IAChB,aAAa;IACb,gBAAgB;IAChB,wBAAwB;AAC5B;;AAEA;EACE,UAAU;AACZ;;AAEA;IACI,gBAAgB;IAChB,aAAa;IACb,aAAa;IACb,mBAAmB;IACnB,aAAa;IACb,qBAAqB;IACrB,QAAQ;IACR,kBAAkB;AACtB;;AAEA;IACI,mBAAmB;IACnB,eAAe;IACf,kBAAkB;IAClB,aAAa;IACb,eAAe;IACf,gCAAgC;AACpC;;AAEA;IACI,YAAY;IACZ,yBAAyB;IACzB,kBAAkB;IAClB,gBAAgB;IAChB,gCAAgC;AACpC;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,+BAA+B;AACnC;;AAEA;IACI,wBAAwB;IACxB,+BAA+B;;AAEnC;;AAEA;IACI,YAAY;AAChB;;AAEA;IACI,mCAAmC;IACnC,yBAAyB;AAC7B;;;;;AAKA;IACI,gBAAgB;IAChB,aAAa;IACb,gBAAgB;AACpB;;AAEA;IACI,gBAAgB;IAChB,aAAa;IACb,YAAY;IACZ,iBAAiB;IACjB,mCAAmC;IACnC,mBAAmB;IACnB,YAAY;IACZ,YAAY;IACZ,kBAAkB;IAClB,sBAAsB;IACtB,gCAAgC;AACpC;AACA;IACI,yBAAyB;AAC7B","sourcesContent":["h1,h2,h3,h4,body, button, span{\n    margin:0;\n    padding: 0;\n}\n\nbody{\n    height: 100vh;\n    display: grid;\n    grid-template-columns: 1fr 5fr;\n    font-family: -apple-system,BlinkMacSystemFont,Trebuchet MS,Roboto,Ubuntu,sans-serif;\n    \n}\n\n/* Sidebar */\n\n.whiteText, .taskName, span{\n    font-size: 1em;\n    color:  rgb(218, 233, 233);\n}\n    \n.greyText, .taskPriority, .taskDate{\n    font-size: 0.9em;\n    color:  rgb(91, 91, 91);\n    min-width: 100px;\n}\n\n#sidebar{\n    padding: 20px 0px;\n    display: flex;\n    flex-direction: column;\n    grid-row: 1;\n    background-color: #000;;\n}\n\n#profileWidget{\n    display: grid;\n    grid-template-columns: 1fr 3fr;\n    column-gap: 25px;\n    margin-bottom: 30px;\n    padding: 0px 20px;\n}\n\n#profileImg{\n    grid-row: 1/3;\n    width: 50px;\n}\n\n#myListDiv {\n    display: flex;\n    justify-content: space-between;\n    margin: 20px 0px ;\n    padding: 0px 10px;\n    padding-right: 20px;\n    \n}\n\n#mylists{\n    padding: 0px 10px;\n}\n\ndiv.tab{\n    padding: 5px 20px;\n}\n\n.tab{\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    transition: all 0.3s ease-in-out;\n    gap: 5px;\n    padding: 5px 0px;\n    padding-right: 20px;\n}\n\n.tab:hover{\n    background-color: #252525;\n}\nsvg{\n    cursor: pointer;\n    width: 15px;\n    padding: 0;\n    margin: 0;\n\n}\n\nbutton{\n    background-color: transparent;\n    border: none;\n    cursor: pointer;\n    flex: 1;\n}\n\n#addNewList{\n    display: flex;\n}\n\n/* New List Modal */\n\ndialog{\n    background-color: hsla(0,0%,100%,.05);\n    top:-20%;\n    border-color: transparent;\n    border-radius: 13px;\n    box-shadow: 4px 4px 5px rgb(0, 0, 0, 90%);\n\n}\n\ndialog::backdrop{\n    background: rgba(0,0,0,05.);    \n    backdrop-filter: blur(5px);  \n}\n\n#listModal{\n    display: grid;\n    grid-template-columns: 2fr 1fr;\n    gap: 20px;\n    padding: 20px;\n    width: 400px;\n}\n\ninput{\n    height: 40px;\n    grid-column: 1/3;\n    grid-row: 2/3;\n    background-color: transparent;\n    border: none;\n    font-size: 1.4em;\n    color: white;\n}\n\ninput:focus{\n    outline: none;\n    border-color: transparent;\n}\n\n#listModal>#createList{\n    color: white;\n    padding: 5px 15px;\n    background-color: rgb(36, 106, 211);\n    border-radius: 15px;\n    grid-column: 2/3;\n    grid-row:3/4\n\n}\n\n#listModal>.svg{\n    grid-column: 2/3;\n    grid-row: 1/2;\n    width: 12px;\n    justify-self: end;\n}\n\n\n\n/* Content Div */\n\n#main{\n    display: flex;\n    flex-direction: column;\n    gap: 50px;\n    height: 100vh;\n    padding: 40px;\n    box-sizing: border-box;\n    background-color: #1c1c1c;\n}\n\n#header{\n    width: fit-content;\n    background-color: rgba(0, 0, 0, 0.90);\n    border-radius: 50px;\n    display: flex;\n    align-content: center;\n}\n\n.headerTitle{\n    color:  rgb(218, 233, 233);\n    padding: 3px 100px 5px 15px;\n    \n}\n\n#content{\n    flex: 1;\n    display: flex;\n    overflow-y: auto;\n    border-radius: 15px;\n    box-shadow: 4px 4px 5px rgb(0, 0, 0, 40%);\n}\n\n\n#taskBoard{\n    display: flex;\n    flex-direction: column;\n    flex: 1;\n    background-color: rgba(0, 0, 0, 0.90);\n    gap:20px;\n    padding: 40px;\n    overflow-y: auto; \n          \n}\n\n#addTaskButton{\n    display: flex;\n    align-content: center;\n    color: white;\n    background-color: #0083ff;\n    border-radius: 15px;\n    padding: 7px 20px;\n    width: fit-content;\n    gap: 10px;\n    transition: all 0.3s ease-in-out;\n\n}\n\n#addTaskButton:hover{\n    background-color: #006aff;\n\n}\n\n#addTaskButton>div{\n    height: 17px;\n    margin: auto;\n}\n\n#addTaskButton>div>svg{\n    width: 17px;\n}\n\n\n\n/* Task card */\n\n.taskCard{\n    display: grid;\n    grid-template-columns: 50px 2fr 5fr;\n    grid-row: 1fr 1fr 1fr;\n    background-color: hsla(0,0%,100%,.05);\n    border: none;\n    flex: 1;\n    max-height: 50px ;\n    padding: 20px;\n    border-radius: 5px;\n}\n\n.toggleCheck{\n    border-radius: 50%;\n    width: 15px;\n    height: 15px;\n    background-color: #252525;\n    border: 1px solid #a2a2a2;\n    transition: all 0.3s ease-in-out;\n    cursor: pointer;\n    grid-column: 1/2;\n    grid-row: 1/4;\n    align-self: center;\n    display: flex;\n    justify-content: center;\n    align-content: center;\n}\n\n.toggleCheck>svg{\n    display: none;\n}\n\n.checked{\n    background-color: #424242;\n    border-color: transparent;\n    \n    \n}\n\n.checked>svg{\n    display: flex;\n}\n\n.completedTask{\n    background-color: transparent;\n    border: 1px solid #424242;\n}\n\n.taskName{\n    grid-column: 2/4;\n    grid-row: 1/2;\n\n}\n\n.taskPriority{\n    grid-column: 2/3;\n    grid-row: 2/3;\n}\n\n.taskDate{\n    grid-column: 2/3;\n    grid-row: 3/4;\n}\n\n.taskActionButtons{\n    grid-column: 3/4;\n    grid-row: 1/4;\n    align-self: center;\n    justify-self: end;\n    display: flex;\n    gap: 5px;\n}\n\n.taskActionLogo{\n    cursor: pointer;\n}\n\n/* New/update Task Modal*/\n\n\n#newTaskModal>form, #updateTaskModal>form{\n    display: grid;\n    grid-template-columns: 3fr 1fr;\n    grid-template-rows: 25px 1fr 1fr 1fr 1fr;\n    padding: 20px;\n    width: 400px\n}\n\nform>.svg{\n    grid-column: 2/3;\n    grid-row: 1/2;\n    justify-self: end;\n}\n\n#taskNameInput{\n    grid-column: 1/3;\n    grid-row: 2/3;\n}\n\n#taskDateInput{\n    grid-column: 2/3;\n    grid-row: 4/5;\n    font-size: 0.9em;\n    justify-self: flex-start;\n}\n\ninput[type=\"date\"]::-webkit-calendar-picker-indicator {\n  opacity: 0;\n}\n\n#prioritySection{\n    grid-column: 1/2;\n    grid-row: 4/5;\n    display: flex;\n    justify-self: start;\n    display: flex;\n    align-content: center;\n    gap: 5px;\n    align-self: center;\n}\n\n.radioButton{\n    height: fit-content;\n    font-size: 12px;\n    width: fit-content;\n    display: flex;\n    cursor: pointer;\n    transition: all 0.3s ease-in-out;\n}\n\nspan{\n    margin: auto;\n    border: 1px solid #a2a2a2;\n    border-radius: 5px;\n    padding: 3px 7px;\n    transition: all 0.3s ease-in-out;\n}\n\ninput[type=\"radio\"]{\n    display: none;\n}\n\n.radioButton:hover{\n    border-color: rgb(36, 106, 211);\n}\n\ninput[type=\"radio\"]:hover + span{\n    color: rgb(36, 106, 211);\n    border-color: rgb(36, 106, 211);\n\n}\n\ninput[type=\"radio\"]:checked:hover + span{\n    color: white;\n}\n\ninput[type=\"radio\"]:checked + span{\n    background-color: rgb(36, 106, 211);\n    border-color: transparent;\n}\n\n\n\n\n#taskListInput{\n    grid-column: 1/3;\n    grid-row: 3/4;\n    font-size: 0.9em;\n}\n\n#createTask, #updateTask{\n    grid-column: 2/3;\n    grid-row: 5/6;\n    color: white;\n    padding: 3px 10px;\n    background-color: rgb(36, 106, 211);\n    border-radius: 10px;\n    width: 150px;\n    height: 30px;\n    align-self: center;\n    justify-self: flex-end;\n    transition: all 0.3s ease-in-out;\n}\n#createTask:hover, #updateTask:hover{\n    background-color: #006aff;\n}\n\n\n"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/add.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/isAfter.js");
...
const dataManager = () =>{
    ...
    const getWeekTasks = () =>{
        let array = [] 
        const todayDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format) (new Date(), 'yyyy-MM-dd')
        const thresholdDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.add)(todayDate,{days:7})

        for (let i=0; i< localStorage.length; i+=1){
            const key = localStorage.key(i)
            const value = JSON.parse(localStorage.getItem(key))
            
            if (!((0,date_fns__WEBPACK_IMPORTED_MODULE_2__.isAfter)(value.date, thresholdDate)) && value.type == "task") {array.push(value)}
            }
        return array
...
/* harmony import */ var _navLogic__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./navLogic */ "./src/logic/navLogic.js");
/* harmony import */ var _userInterface_genericPage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../userInterface/genericPage */ "./src/userInterface/genericPage.js");
...
const toggleCheckTask = (e, taskId) => {
    ...
    ;(0,_userInterface_genericPage__WEBPACK_IMPORTED_MODULE_2__.updateTaskUI)(e, taskId)
    const task = (0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().getDataById(taskId)
    task.check = task.check == "off" ? "on" : "off" 

    ;(0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().saveToStorage(task)
    
}

const openEditTaskModal = (taskId) => {
    updateTaskModal.showModal()
    ;(0,_userInterface_genericPage__WEBPACK_IMPORTED_MODULE_2__.loadDataToModal)(taskId)
...
const deleteTask = (taskId) => {
    ...
    const task = (0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().getDataById(taskId)                          
    const list = (0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().getDataByListName(task.listName)
    const listWithMethods = Object.assign(new _data__WEBPACK_IMPORTED_MODULE_0__.TaskList(), list);
    
    listWithMethods.removeTaskFromList(task)                        //delete from list 
    
    ;(0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().saveToStorage(listWithMethods)                    //save updated list to storage
    
    const taskCard = document.querySelector(`[data-taskId="${taskId}"]`)    //delete from takboard card
    taskCard.remove()
    
    ;(0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().deleteDataById(taskId)                    //delete from storage
}
...
const addTask= (e) => {
    ...
    const listObj = (0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().getDataByListName(list)
    
    if (listObj === null){                                  //check if task list exists and create a new one if it doesn't
        
        const newList = (0,_navLogic__WEBPACK_IMPORTED_MODULE_1__.createNewList)(list)
        const newTask = new _data__WEBPACK_IMPORTED_MODULE_0__.Task(title,date, priority, list)

        newList.addTasktoList(newTask)
        ;(0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().saveToStorage(newTask)
        ;(0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().saveToStorage(newList)

    }else {                                                         
        const newTask = new _data__WEBPACK_IMPORTED_MODULE_0__.Task(title,date, priority, list)
        
        const listWithMethods = Object.assign(new _data__WEBPACK_IMPORTED_MODULE_0__.TaskList(), listObj)  //saved obj to local storage loose methods. This creates a new fully functioning obj copy 
        listWithMethods.addTasktoList(newTask)

        ;(0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().saveToStorage(newTask)
        ;(0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().saveToStorage(listObj)
    ...
    ;(0,_navLogic__WEBPACK_IMPORTED_MODULE_1__.renderAllTasks)()
...
const updateTask = (e) => {
    ...
    const currentListObj = (0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().getDataByListName(task.listName)
    const currentListObjwithMethods = Object.assign(new _data__WEBPACK_IMPORTED_MODULE_0__.TaskList(), currentListObj)
    ...
    let listTargetObj = (0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().getDataByListName(task.listName)
    
    if (listTargetObj === null){                                  //check if task list exists and create a new one if it doesn't
        
        listTargetObj = (0,_navLogic__WEBPACK_IMPORTED_MODULE_1__.createNewList)(task.listName)
        listTargetObj.addTasktoList(task)
        
    }else {                                                         
        
        listTargetObj = Object.assign(new _data__WEBPACK_IMPORTED_MODULE_0__.TaskList(), listTargetObj)  //saved obj to local storage loose methods. This creates a new fully functioning obj copy (not saved in storage so does not duplicate data entries)
        listTargetObj.addTasktoList(task)
    }
    
    (0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().saveToStorage(currentListObjwithMethods)
    ;(0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().saveToStorage(task)
    ;(0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().saveToStorage(listTargetObj)
    updateTaskModal.close()
...
/* harmony export */ });
/* harmony import */ var _data__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../data */ "./src/data.js");
/* harmony import */ var _userInterface_genericPage__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../userInterface/genericPage */ "./src/userInterface/genericPage.js");
/* harmony import */ var _userInterface_navSection__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../userInterface/navSection */ "./src/userInterface/navSection.js");
/* harmony import */ var _contentLogic__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./contentLogic */ "./src/logic/contentLogic.js");
...
const createNewList = (listName) => {
    ...
    if ((0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().getDataByListName(listName)!= null) {
        return (alert("You already have a list with this name."))
        }
    const list = new _data__WEBPACK_IMPORTED_MODULE_0__.TaskList(listName)
    ;(0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().saveToStorage(list)
    ;(0,_userInterface_navSection__WEBPACK_IMPORTED_MODULE_2__.addListTab)(list)
...
const renderAllListTabs = () => {
    ...
    const listArray = (0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().getAllLists()
...
const deleteList = (listId)=>{
    ...
    const listContent = (0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().getDataById(listId).tasks     
    listContent.forEach(task => (0,_contentLogic__WEBPACK_IMPORTED_MODULE_3__.deleteTask)(task.id))                //delete all tasks from the list

    ;(0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().deleteDataById(listId)                            //delete List from local storage
    ;(0,_userInterface_navSection__WEBPACK_IMPORTED_MODULE_2__.deleteListTab)(listId)                                           //delete from DOM
    renderWeekTasks()
}

const renderAllTasks = () =>{
    ;(0,_userInterface_genericPage__WEBPACK_IMPORTED_MODULE_1__.printHeader)("All Tasks")
    ;(0,_userInterface_genericPage__WEBPACK_IMPORTED_MODULE_1__.addTaskBoard)()

    const tasksArray = (0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().getAllTasks()

    tasksArray.forEach(task => (0,_userInterface_genericPage__WEBPACK_IMPORTED_MODULE_1__.loadTaskCard)(task))

}

const renderWeekTasks = () =>{
    ;(0,_userInterface_genericPage__WEBPACK_IMPORTED_MODULE_1__.printHeader)("Next 7 days")
    ;(0,_userInterface_genericPage__WEBPACK_IMPORTED_MODULE_1__.addTaskBoard)()

    const tasksArray = (0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().getWeekTasks()
...
const renderTasksByList = (listId) =>{
    const listObj= (0,_data__WEBPACK_IMPORTED_MODULE_0__.dataManager)().getDataById(listId)

    const tasksArray = listObj.tasks

    ;(0,_userInterface_genericPage__WEBPACK_IMPORTED_MODULE_1__.printHeader) (listObj.name)
    ;(0,_userInterface_genericPage__WEBPACK_IMPORTED_MODULE_1__.addTaskBoard)()                          // add empty taskboard
...
/***/ "./src/userInterface/genericPage.js":
/*!******************************************!*\
  !*** ./src/userInterface/genericPage.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addTaskBoard: () => (/* binding */ addTaskBoard),
/* harmony export */   loadDataToModal: () => (/* binding */ loadDataToModal),
...
/***/ "./src/userInterface/navSection.js":
/*!*****************************************!*\
  !*** ./src/userInterface/navSection.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   addListTab: () => (/* binding */ addListTab),
/* harmony export */   deleteListTab: () => (/* binding */ deleteListTab)
/* harmony export */ });
...
/* harmony import */ var _logic_navLogic__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./logic/navLogic */ "./src/logic/navLogic.js");
/* harmony import */ var _logic_contentLogic__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./logic/contentLogic */ "./src/logic/contentLogic.js");
